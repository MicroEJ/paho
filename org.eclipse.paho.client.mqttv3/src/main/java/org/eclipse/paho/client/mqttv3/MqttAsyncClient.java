...
public class MqttAsyncClient implements IMqttAsyncClient { // DestinationProvider
	...
	public MqttAsyncClient(String serverURI, String clientId,
		...
		if (clientIdLength > 65535) {
			throw new IllegalArgumentException(
					"ClientId longer than 65535 characters");
		}
	 ...
	 * @return a network module appropriate to the specified address.
	 */
	private NetworkModule createNetworkModule(String address,
			MqttConnectOptions options) throws MqttException,
			MqttSecurityException {
		...
		NetworkModuleFactory networkModuleFactory = (NetworkModuleFactory) DependencyInjectionHelper.getImplementation(NetworkModuleFactory.class);
		return networkModuleFactory.createNetworkModule(address, options, clientId);
	}
	...
	public IMqttToken connect(MqttConnectOptions options, Object userContext,
		...
		if (comms.isConnected()) {
			throw ExceptionHelper
					.createMqttException(MqttException.REASON_CODE_CLIENT_CONNECTED);
		}
		...
		ConnectActionListener connectActionListener = new ConnectActionListener(
				this, persistence, comms, options, userToken, userContext,
				callback);
	...
	public IMqttToken disconnect(long quiesceTimeout, Object userContext,
		...
		log.fine(CLASS_NAME, methodName, "104", new Object[] {
				new Long(quiesceTimeout), userContext, callback });
	 ...
	 * <ul>
	 * <li>
	 * {@link MqttAsyncClient#publish(String, MqttMessage, MqttDeliveryToken)}
	 * to publish a message in a non-blocking manner or
	 * <li>
	 * {@link MqttClient#publishBlock(String, MqttMessage, MqttDeliveryToken)}
	 ...
	 * 
	 * @see
	 * org.eclipse.paho.client.mqttv3.IMqttAsyncClient#subscribe(java.lang.String
	...
	public IMqttToken subscribe(String[] topicFilters, int[] qos,
		...
		log.fine(CLASS_NAME, methodName, "106", new Object[] { subs,
				userContext, callback });
	...
	public IMqttToken unsubscribe(String[] topicFilters, Object userContext,
		...
		log.fine(CLASS_NAME, methodName, "107", new Object[] { subs,
				userContext, callback });
	...
	public IMqttDeliveryToken publish(String topic, MqttMessage message,
		...
		log.fine(CLASS_NAME, methodName, "111", new Object[] { topic,
				userContext, callback });
